 ...
 */
public class ColocarPlayer2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelPos01.setText("[4][1]");
        getContentPane().add(jLabelPos01);
        jLabelPos01.setBounds(170, 110, 80, 80);
        ...
        jLabelPos02.setText("[4][2]");
        getContentPane().add(jLabelPos02);
        jLabelPos02.setBounds(270, 110, 80, 80);
        ...
        jLabelPos03.setText("[4][3]");
        getContentPane().add(jLabelPos03);
        jLabelPos03.setBounds(370, 110, 90, 80);
        ...
        jLabelPos04.setText("[4][4]");
        getContentPane().add(jLabelPos04);
        jLabelPos04.setBounds(480, 110, 80, 80);
        ...
        jLabelPos14.setText("[5][4]");
        getContentPane().add(jLabelPos14);
        jLabelPos14.setBounds(470, 210, 90, 90);
        ...
        jLabelPos13.setText("[5][3]");
        getContentPane().add(jLabelPos13);
        jLabelPos13.setBounds(370, 210, 90, 90);
        ...
        jLabelPos12.setText("[5][2]");
        getContentPane().add(jLabelPos12);
        jLabelPos12.setBounds(270, 210, 90, 90);
        ...
        jLabelPos11.setText("[5][1]");
        getContentPane().add(jLabelPos11);
        jLabelPos11.setBounds(170, 210, 80, 80);
        ...
        jLabel2.setBounds(780, 314, 210, 20);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ghostsvisual/SemiTableroPlayer2.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 1000, 351);
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        if(GhostsMenuPrincipal.Dificultad == 0){
            if(PiezasColocadas < PiezasxColocar/2){
    ...
    private void ValidarContinuacion(){
        if(PiezasColocadas == PiezasxColocar){
            ColocarPlayer2 abrir = new ColocarPlayer2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColocarPlayer2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColocarPlayer2().setVisible(true);
            }
        });
    }
