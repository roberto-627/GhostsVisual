 ...
 */
public class SubmenuUlt10Juegos extends javax.swing.JFrame {

    public SubmenuUlt10Juegos() {
        initComponents();
        ImprimirUlt10Juegos();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("A continuacion se muestran los resultados de tus ultimos 10 juegos.");
        getContentPane().add(jLabelTitulo);
        jLabelTitulo.setBounds(300, 200, 420, 30);
        ...
        jLabel1.setBounds(340, 230, 20, 20);
        ...
        jLabel2.setBounds(340, 250, 20, 17);
        ...
        jLabel3.setBounds(340, 270, 20, 17);
        ...
        jLabel4.setBounds(340, 290, 20, 17);
        ...
        jLabel5.setBounds(340, 310, 20, 17);
        ...
        jLabel6.setBounds(340, 330, 20, 17);
        ...
        jLabel7.setBounds(340, 350, 20, 17);
        ...
        jLabel8.setBounds(340, 370, 20, 17);
        ...
        jLabel9.setBounds(340, 390, 20, 17);
        ...
        jLabel10.setBounds(340, 410, 20, 17);
        ...
        jLabelJuego1.setBounds(370, 230, 140, 20);
        ...
        jLabelJuego2.setBounds(370, 250, 140, 20);
        ...
        jLabelJuego3.setBounds(370, 270, 140, 20);
        ...
        jLabelJuego4.setBounds(370, 290, 140, 20);
        ...
        jLabelJuego5.setBounds(370, 310, 140, 20);
        ...
        jLabelJuego6.setBounds(370, 330, 140, 20);
        ...
        jLabelJuego7.setBounds(370, 350, 140, 20);
        ...
        jLabelJuego8.setBounds(370, 370, 140, 20);
        ...
        jLabelJuego9.setBounds(370, 390, 140, 20);
        ...
        jLabelJuego10.setBounds(370, 410, 140, 20);

        jLabelBackground.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabelBackground.setIcon(new javax.swing.ImageIcon("C:\\Users\\Roberto Melara\\Documents\\Sub-MenusUlt10.png")); // NOI18N
        getContentPane().add(jLabelBackground);
        jLabelBackground.setBounds(0, 0, 750, 590);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubmenuUlt10Juegos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubmenuUlt10Juegos().setVisible(true);
            }
        });
    }
    ...
    public void ImprimirUlt10Juegos(){
        ...
        jLabelJuego3.setText(Player.usuarios[Player.posuser1].ult10[2]);
        jLabelJuego4.setText(Player.usuarios[Player.posuser1].ult10[3]);
        jLabelJuego5.setText(Player.usuarios[Player.posuser1].ult10[4]);
        jLabelJuego6.setText(Player.usuarios[Player.posuser1].ult10[5]);
        jLabelJuego7.setText(Player.usuarios[Player.posuser1].ult10[6]);
        jLabelJuego8.setText(Player.usuarios[Player.posuser1].ult10[7]);
        jLabelJuego9.setText(Player.usuarios[Player.posuser1].ult10[8]);
        jLabelJuego10.setText(Player.usuarios[Player.posuser1].ult10[9]);
    }
